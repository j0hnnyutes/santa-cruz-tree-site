...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${siteUrl}/api/og?title=Tree+Service+in+Ben+Lomond%2C+CA&photo=tree-removal-with-crane`,
        width: 1200,
        height: 630,
        alt: "Tree Service in Ben Lomond, CA — Santa Cruz Tree Pros",
      },
    ],
  },
...
export default function BenLomondPage() {
  ...
  return (
    <>
      <CityHero
        heading="Tree Service in Ben Lomond, CA"
        subheading="Sectional redwood work and access specialists in the San Lorenzo Valley"
