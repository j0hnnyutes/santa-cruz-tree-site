...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${siteUrl}/api/og?title=Tree+Service+in+Capitola%2C+CA&photo=tree-removal-with-crane`,
        width: 1200,
        height: 630,
        alt: "Tree Service in Capitola, CA — Santa Cruz Tree Pros",
      },
    ],
  },
...
export default function CapitolaPage() {
  ...
  return (
    <>
      <CityHero
        heading="Tree Service in Capitola, CA"
        subheading="Expert care for coastal cypress, mature pines, and tight beachside lots"
